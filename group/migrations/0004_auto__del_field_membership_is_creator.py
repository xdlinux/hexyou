...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MemberShip.is_creator'
        db.delete_column('group_membership', 'is_creator')


    def backwards(self, orm):
        
        # Adding field 'MemberShip.is_creator'
        db.add_column('group_membership', 'is_creator', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

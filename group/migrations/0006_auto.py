...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field friend_groups on 'Group'
        db.create_table('group_group_friend_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_group', models.ForeignKey(orm['group.group'], null=False)),
            ('to_group', models.ForeignKey(orm['group.group'], null=False))
        ))
        db.create_unique('group_group_friend_groups', ['from_group_id', 'to_group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field friend_groups on 'Group'
        db.delete_table('group_group_friend_groups')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberShip.is_approved'
        db.add_column('group_membership', 'is_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberShip.is_approved'
        db.delete_column('group_membership', 'is_approved')

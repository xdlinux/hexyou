...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('group_group', (
            ...
            ('founder', self.gf('django.db.models.fields.related.ForeignKey')(related_name='founder', to=orm['auth.User'])),
            ...
            ('group_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['group.GroupType'])),

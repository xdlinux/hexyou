...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityPhoto.activity'
        db.alter_column('activity_activityphoto', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['activity.Activity']))


    def backwards(self, orm):
        
        # Changing field 'ActivityPhoto.activity'
        db.alter_column('activity_activityphoto', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activity.Activity']))

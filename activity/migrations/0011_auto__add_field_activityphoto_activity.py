...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityPhoto.activity'
        db.add_column('activity_activityphoto', 'activity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos', null=True, to=orm['activity.Activity']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ActivityPhoto.activity'
        db.delete_column('activity_activityphoto', 'activity_id')
    ...
    models = {
        ...
        'activity.activityphoto': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'null': 'True', 'to': "orm['activity.Activity']"}),

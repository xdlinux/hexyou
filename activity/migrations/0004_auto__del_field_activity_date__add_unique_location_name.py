...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('activity_activity', 'date')
    ...
    def backwards(self, orm):
        ...
        db.add_column('activity_activity', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 30)), keep_default=False)

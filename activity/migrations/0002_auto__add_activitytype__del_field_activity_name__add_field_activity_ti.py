...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('activity_activitytype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('activity', ['ActivityType'])

        # Deleting field 'Activity.name'
        db.delete_column('activity_activity', 'name')

        # Adding field 'Activity.title'
        db.add_column('activity_activity', 'title', self.gf('django.db.models.fields.CharField')(default=0, max_length=30), keep_default=False)

        # Adding field 'Activity.slug'
        db.add_column('activity_activity', 'slug', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Adding field 'Activity.avatar'
        db.add_column('activity_activity', 'avatar', self.gf('django.db.models.fields.CharField')(default='/static/images/no_avatar.png', max_length=100), keep_default=False)

        # Adding field 'Activity.activity_type'
        db.add_column('activity_activity', 'activity_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['activity.ActivityType']), keep_default=False)

        # Changing field 'Activity.description'
        db.alter_column('activity_activity', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting model 'ActivityType'
        db.delete_table('activity_activitytype')

        # Adding field 'Activity.name'
        db.add_column('activity_activity', 'name', self.gf('django.db.models.fields.CharField')(default=0, max_length=30), keep_default=False)

        # Deleting field 'Activity.title'
        db.delete_column('activity_activity', 'title')

        # Deleting field 'Activity.slug'
        db.delete_column('activity_activity', 'slug')

        # Deleting field 'Activity.avatar'
        db.delete_column('activity_activity', 'avatar')

        # Deleting field 'Activity.activity_type'
        db.delete_column('activity_activity', 'activity_type_id')

        # Changing field 'Activity.description'
        db.alter_column('activity_activity', 'description', self.gf('django.db.models.fields.TextField')(default=0))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'avatar': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),

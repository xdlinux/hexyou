...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('activity_location', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['activity.Location']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.parent'
        db.delete_column('activity_location', 'parent_id')
    ...
    models = {
        ...
        'activity.location': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['activity.Location']"})
        },
        'auth.group': {

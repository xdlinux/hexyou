...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityPhoto.thumbnail'
        db.add_column('activity_activityphoto', 'thumbnail', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityPhoto.thumbnail'
        db.delete_column('activity_activityphoto', 'thumbnail')
    ...
    models = {
        'activity.activity': {
            ...
            'host_groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['group.Group']", 'symmetrical': 'False', 'through': "orm['activity.HostShip']", 'blank': 'True'}),
            ...
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'participated_activities'", 'blank': 'True', 'through': "orm['activity.MemberHostShip']", 'to': "orm['auth.User']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'activity.activityphoto': {
            'Meta': {'object_name': 'ActivityPhoto'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['activity.Activity']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'thumbnail': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'})
        },

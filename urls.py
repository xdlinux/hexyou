...
urlpatterns = patterns('',
    ...
    url(r'^activities/(\d+)/$','NearsideBindings.activity.views.single'),
    url(r'^activities/(\d+)/edit$','NearsideBindings.activity.views.edit'),
    url(r'^activities/create/?$','NearsideBindings.activity.views.create'),
    url(r'^activities/my/(\w{1,12})?$','NearsideBindings.activity.views.my'),
    url(r'^activities/sort/(\w{1,12})/(\d+)?$','NearsideBindings.activity.views.sort'),
    url(r'^activities/random/?$','NearsideBindings.activity.views.random'),
    ...
    url(r'^groups/my/?$','NearsideBindings.group.views.my'),
    ...
    url(r'^groups/(\w{1,50})/exit/?$','NearsideBindings.group.views.exit'),
    url(r'^groups/(\w{1,50})/disband/?$','NearsideBindings.group.views.disband'),
